...
//    }
    ...
    /**
     * Endpoint thống nhất để gửi OTP (có thể dùng cho cả User và Admin)
     * Tham số 'type' để phân biệt: "user" hoặc "admin"
     */
    @PostMapping("/forgot-password")
    public ResponseEntity<?> sendOtp(@Valid @RequestBody YeuCauOTP yeuCauOTP,
    ...
    /**
     * Endpoint thống nhất để đặt lại mật khẩu (có thể dùng cho cả User và Admin)
     * Tham số 'type' để phân biệt: "user" hoặc "admin"
     */
    @PostMapping("/reset-password")
    public ResponseEntity<?> resetPassword(@Valid @RequestBody YeuCauXacThucOPT yeuCauXacThuc,
                                           @RequestParam(defaultValue = "user") String type) {
        try {
            if ("admin".equalsIgnoreCase(type)) {
                adminPasswordResetService.verifyOtpAndResetPassword(
    ...
    // Inner class cho MessageResponse
